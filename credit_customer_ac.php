...
<body>
	...
	<div class="container flex justify-center items-center py-10">
		<form method="post" class="bg-slate-200 flex flex-col w-80 p-5 rounded-md">
			<input type="text" name="customer_account_no" placeholder="Customer A/c No" class="form-control" required><br>
			<input type="text" name="credit_amount" placeholder="Amount" class="form-control" required><br>
			<input class="btn btn-primary" type="submit" name="credit_btn" value="Credit" >
		</form>
	</div>
