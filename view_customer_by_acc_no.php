...
<body>
    ...
    <div class="container flex justify-center items-center py-10">
        <form method="POST" class="bg-slate-200 flex flex-col w-80 p-5 rounded-md">
            <input name="account_no" placeholder="Customer Account No" class="form-control mb-3">
            <input type="submit" name="submit_view" value="SUBMIT" class="btn bg-blue-700 text-white hover:bg-blue-800">
        </form>
    </div>
