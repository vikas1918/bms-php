...
<body>
    ...
    <h5 class="text-center mt-10 text-cyan-800">Apply Debit Card</h5>
    <div class="container w-10 rounded-lg shadow-lg pt-4 px-10 bg-slate-200 my-10" style="width: 300px;">
        <form method="POST" class="flex flex-col justify-center">
            <input class="form-control" type="text" name="holder_name" placeholder="Account Holder Name"><br>
            <input class="form-control" type="text" name="dob" placeholder="Date of Birth" onfocus="(this.type='date')"><br>
            <input class="form-control" type="text" name="pan" placeholder="PAN"><br>
            <input class="form-control" type="text" name="mob" placeholder="Registered Mobile (10 Digit)"><br>
            <input class="form-control" type="text" name="acc_no" placeholder="Account No"><br>
            <input class="btn btn-primary" type="submit" name="dbt_crd_submit" value"SUBMIT"><br>
        <form>
    </div>
</body>
