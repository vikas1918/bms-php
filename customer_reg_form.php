...
<body>
	<div class="container my-10">
		<h1 class="text-center text-2xl bg-cyan-900 text-white py-3 rounded-lg mb-10">Online Account Opening Form</h1>

		<div class="rounded-lg shadow-lg p-6 bg-slate-200">
			...
			<form method="post">
				...
				<div class="row mb-3">
					<div class="col-md-4">
						<input class="form-control" type="text" name="landline" placeholder="Landline no" />
					</div>
					<div class="col-md-2">
					...
					<div class="col-md-3">
						<input class="form-control" type="text" name="citizenship" placeholder="Citizenship Number" required />
					</div>
				</div>

				<input class="form-control mb-3" type="text" name="homeaddrs" placeholder="Home Address" required />
				<input class="form-control mb-3" type="text" name="officeaddrs" placeholder="Office Address" />

				<div class="row mb-3">
					<div class="col">
						<input class="form-control" type="text" name="country" placeholder="INDIA" readonly="readonly" />
					</div>
					<div class="col">
						<!-- STATES -->
				...
				<input class="form-control mb-3" type="text" name="arealoc" placeholder="Area/Locality" required />
				...
				<input class="form-control btn btn-primary text-black py-2" type="submit" name="submit" value="SUBMIT">
			</form>
		</div>
